...
void setup() {
  ...
  */
  ...
  // this is how example showed to do it, but it pulled more power and didn't actually turn off 48.
  //gpio_pullup_en(GPIO_NUM_48);
  //gpio_pulldown_en(GPIO_NUM_48);

  // This seemed to pull less power.
  //pinMode(48, OUTPUT);
  //digitalWrite(48, 0);
